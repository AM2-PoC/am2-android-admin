...
- Create immutable annotated `admin/vX.Y.Z` tags only at the exact source SHA for an accepted signed artifact. Record package, versionCode/versionName, APK digest, signer, and CI evidence; never move an accepted tag.
